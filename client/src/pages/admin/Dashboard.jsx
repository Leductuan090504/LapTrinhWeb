...
const Dashboard = () => {
    ...
    const dashboardCards = [
        { title: "Vé Đã Đặt", value: dashboardData.totalBookings || "0", icon: ChartLineIcon },
        { title: "Tổng Doanh Thu", value: currency + dashboardData.totalRevenue || "0", icon: CircleDollarSignIcon },
        { title: "Suất Chiếu Đang Hoạt Động", value: dashboardData.activeShows.length || "0", icon: PlayCircleIcon },
